...
LAND_DEFAULT_EXPOSURE = 1.0
LAND_DEFAULT_GAMMA = 2.8
LAND_DEFAULT_SHOULDER = 0.6
LAND_DEFAULT_SATURATION = 0.9
LAND_DEFAULT_GRADE_LOW_BREAK = 0.08
LAND_DEFAULT_GRADE_HIGHLIGHT_BREAK = 0.82
LAND_DEFAULT_GRADE_LOW_SLOPE = 0.7
LAND_DEFAULT_GRADE_MID_SLOPE = 1.0
LAND_DEFAULT_GRADE_HIGHLIGHT_SLOPE = 1.05
