...
- `--parallel`: Number of worker processes/threads used for tile, chunk, and overview generation (default: `2`).
...
- `--resume`: Reuse matching cached work, staged MBTiles, and completed overview tiles after an interrupted run.
