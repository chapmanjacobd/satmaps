...
def test_apply_soft_knee_numpy_basics() -> None:
    ...
    toned = apply_soft_knee_numpy(arr, shadow_break=0.3, highlight_break=0.75, 
                                  shadow_slope=1.4, mid_slope=0.9, highlight_slope=0.5)
...
def test_apply_preview_correction_numpy_basics() -> None:
    ...
    corrected = apply_preview_correction_numpy(rgb, saturation=0.9, darken_break=0.7, low_slope=0.7, gamma=1.0)
...
def test_run_tiling_simplified_creates_mbtiles(tmp_path: Path, monkeypatch: object) -> None:
